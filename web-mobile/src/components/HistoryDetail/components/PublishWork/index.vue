...
const handleSubmit = async () => {
  ...
  const response = await publishToSquare({
    ...
    drawTaskId: props.taskInfo.type === EFunctionGroupMode.DRAWING ? props.taskInfo.id : undefined,
    editedTaskId:
      props.taskInfo.type !== EFunctionGroupMode.DRAWING ? props.taskInfo.id : undefined,
  });
